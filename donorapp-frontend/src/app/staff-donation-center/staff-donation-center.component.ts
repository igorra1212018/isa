...
export class StaffDonationCenterComponent implements OnInit {
    ...
    constructor(
        ...
        private _staffDonationCenterService: StaffDonationCenterService,
        private _staffService: StaffService
    ) {}

    loadTerms(centerId: number) {
        this._staffDonationCenterService.getFreeTerms(centerId).subscribe(
            (data) => {
                this.terms = data;
    ...
    ngOnInit() {
        ...
        this._staffDonationCenterService.getDonationCenter(centerId).subscribe(
            (data) => {
                this.center = data;
